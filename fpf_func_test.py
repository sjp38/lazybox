...
for cpu in ["1ffff"]:
    for workload in ["-p1 -H1 -m1 -c1 -t40"]:
        for assertion in [
		    ...
		    '-A "method:GET/accept:*\/*/referer:http:\/\/with.gsshop.com\/prd\/prd.gs?prdid=14157618&vodFlag=N&utm_source=Remarketing&utm_medium=advertise&utm_campaign=adbey_pop/user-agent:Mozilla\/4.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident\/4.0; .NET CLR 2.0.50727; .NET CLR 3.0.450" ',
